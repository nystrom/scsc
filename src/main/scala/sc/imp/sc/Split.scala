...
trait EvSplit extends SplitArgs {
  this: Split with sc.imp.machine.Terms with Envs with Stores with sc.imp.machine.Continuations with States with Rollback =>
...
trait SplitBranch {
  this: sc.imp.machine.Terms with Envs with Stores with sc.imp.machine.Continuations with States with Rollback =>
